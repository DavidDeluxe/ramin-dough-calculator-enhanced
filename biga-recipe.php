...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col">
            <ul class="list-group">
            <li class="list-group-item">
                <input class="form-check-input me-1" type="checkbox" value="" id="LastFermentation-step1">
                <label class="form-check-label stretched-link" for="LastFermentation-step1">Mix all together in mixer</label>
            </li>
            <li class="list-group-item">
                <input class="form-check-input me-1" type="checkbox" value="" id="LastFermentation-step2">
                <label class="form-check-label stretched-link" for="LastFermentation-step2">Knead dough and form into ball. </label>
            </li>
            <li class="list-group-item">
            ...
            <li class="list-group-item">
                ...
                <label class="form-check-label stretched-link" for="LastFermentation-step4"><p>Cover and place in fridge another 24 hours.</p> <p>Dough should be smooth on the surface, bounce back when poked, and pass the windowpane test.</p></label>
            </li>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <li class="list-group-item">
                ...
                <label class="form-check-label stretched-link" for="bake-step1"><p>Take out of fridge</p> </label>
            </li>
            <li class="list-group-item">
                <input class="form-check-input me-1" type="checkbox" value="" id="bake-step2">
                <label class="form-check-label stretched-link" for="bake-step2">Form pizza bases and bake!</label>
            </li>
            </ul>
        </div>
    </div>
...
function refresh_data() {
    ...
    var labelDateTimeToStartBakeEarliest = dayjs(eatDateTime).subtract(6, 'hour').format("ddd, DD-MMM-YYYY HH:mm");
    var labelDateTimeToStartBakeLatest = dayjs(eatDateTime).subtract(3, 'hour').format("ddd, DD-MMM-YYYY HH:mm");

    //var labelDateTimeToStartFinalSteps;
    var labelStepFinalMixDateTimeEarliest = dayjs(labelDateTimeToStartBakeEarliest).subtract(24, 'hour').format("ddd, DD-MMM-YYYY HH:mm");;
    var labelStepFinalMixDateTimeLatest = dayjs(labelDateTimeToStartBakeLatest).subtract(16, 'hour').format("ddd, DD-MMM-YYYY HH:mm");;
    ...
    $("#labelDateTimeToStartBake").html("<i class='bi bi-clock'></i> Recommended time to start: Between <b>" + labelDateTimeToStartBakeEarliest + "</b> and <b>" + labelDateTimeToStartBakeLatest + "</b>");
